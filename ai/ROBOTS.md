...
Fill this in per derived company. Check `https://hochland.ro/robots.txt` before the
...
| Path | Role |
|---|---|
| `https://hochland.ro/cariere/` | Public list of open positions (server-rendered HTML) |
| `https://hochland.ro/sitemap_index.xml` | Job sitemap — canonical `https://hochland.ro/cariere/<slug>/` permalinks |
| `https://hochland.ro/cariere/<slug>/` | Individual job pages (only referenced, not fully crawled) |
