...
This scraper extracts job listings for **HOCHLAND ROMANIA SRL** (CIF: 10666988) from the company's own careers site and from ANOFM, and imports them to peviitor.ro.

Targets: https://hochland.ro/cariere/, https://hochland.ro/sitemap_index.xml, https://mediere.anofm.ro
...
- **Hochland — listing**: `https://hochland.ro/cariere/` — pagina publică de posturi deschise (HTML server-rendered)
- **Hochland — sitemap**: `https://hochland.ro/sitemap_index.xml` — permalink-uri canonice `/joburi/<slug>/`
