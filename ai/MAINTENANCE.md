...
```bash
gh issue list --repo TheTatu13/hochland-romania-nodejs-scraper --state open
```
...
- `docs/test-results/index.html` — branding must say "HOCHLAND ROMANIA SRL", not the old template
