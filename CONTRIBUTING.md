...
Open a [GitHub Issue](https://github.com/TheTatu13/hochland-romania-nodejs-scraper/issues) with:
...
- the company's own careers listing (`https://hochland.ro/cariere/`) + its job sitemap (`https://hochland.ro/sitemap_index.xml`)
- ANOFM (by CIF)
